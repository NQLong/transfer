...
DATABASES = {
    "default": dj_database_url.config(
        default=f"postgres://saleor:saleor@{DATABASE_URL}:{DATABASE_PORT}/saleor", conn_max_age=600
    )
}
...
EMAIL_HOST_PASSWORD='Blacksnow1904'
EMAIL_HOST_USER='nqlong.dev@gmail.com'
...
PAYMENT_VARIANTS = {
    'paypal': ('payments.paypal.PaypalProvider', {
        'client_id': 'AWVP31qsqILKAeEZYZRGAggrhyOtXNmtef75-o8YftHQTxixndGr0BRSSZgXygWhfWHPn_JzISMtQwlL',
        'secret': 'EGaM2zR5hprwtpezB3j8EFh-7Ecs80kun0oYY-fGreQXe1ci2Y40mCUUpCxxAwrBpDpWcZy1ltR5O1M7',
        'endpoint': 'https://api.sandbox.paypal.com',  # 'https://api.paypal.com' for production use (through the 'live account' API credentials)
        'capture': False
        })} 

CHECKOUT_PAYMENT_CHOICES = [('paypal', 'paypal')]
