module.exports = (app, appConfig) => {
    ...
    app.parentMenu = {
        ...
        user: {
            ...
            subMenusRender: false, groups: ['Thông tin cá nhân', 'Công tác', 'Khen thưởng - kỷ luật', 'Nghỉ', 'Chuyên môn', 'Văn phòng điện tử', 'Đánh giá']
        },
        tccb: {
        ...
        sdh: {
            ...
            subMenusRender: false, groups: ['NGÀNH', 'CÔNG TÁC', 'DANH MỤC', 'SINH VIÊN']
        },
        category: {
