...
const Canvas = ({ width = 570, height = 380, lineWith = 4, lineColor = defaultLineColor, style = {}, onChangeSigData, shcc, canvasRef, contextRef }) => {
    ...
    return (
        <>
            ...
            <FileBox ref={uploadFileRef} postUrl='/user/upload' uploadType='hcthSignatureFile' userData={`hcthSignatureFile:${shcc}`} style={{ display: 'none' }} success={onSuccess} ajax={true} />
        </>
    );
};