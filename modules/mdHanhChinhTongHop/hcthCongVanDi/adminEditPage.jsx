            ...
            content: this.state.isLoading ? loading : (<>
                <div className='tile'>
                    ...
                    <div className='tile-body row'>
                        ...
                        <FormSelect ref={e => this.loaiCongVan = e} readOnly={this.canReadOnly()} disabled={this.state.id && this.state.trangThai != trangThaiCongVanDi.NHAP.id} label='Cấp văn bản' placeholder='Chọn cấp văn bản' className='col-md-6' data={loaiCongVanArr} readOnlyEmptyText='Chưa có loại văn bản' onChange={value => this.onChangeLoaiCongVan(value)} required />
