// Table name: HCTH_CONG_VAN_DI { id, noiDung, ngayGui, ngayKy, donViGui, donViNhan }
const keys = ['ID'];
const obj2Db = { 'id': 'ID', 'noiDung': 'NOI_DUNG', 'ngayGui': 'NGAY_GUI', 'ngayKy': 'NGAY_KY', 'donViGui': 'DON_VI_GUI', 'donViNhan': 'DON_VI_NHAN' };
