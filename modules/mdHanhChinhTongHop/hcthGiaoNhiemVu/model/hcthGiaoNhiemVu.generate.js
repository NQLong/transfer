// Table name: HCTH_GIAO_NHIEM_VU { id, nguoiTao, nguoiNhan, donViNhan, ngayHetHan, noiDung }
const keys = ['ID'];
const obj2Db = { 'id': 'ID', 'nguoiTao': 'NGUOI_TAO', 'canBoNhan': 'CAN_BO_NHAN', 'donViNhan': 'DON_VI_NHAN', 'ngayHetHan': 'NGAY_HET_HAN', 'noiDung': 'NOI_DUNG' };
...
module.exports = app => {
    app.model.hcthGiaoNhiemVu = {
        ...
        getAllPhanHoi: (idnhiemvu, done) => {
            app.database.oracle.connection.main.execute('BEGIN :ret:=hcth_giao_nhiem_vu_get_all_phan_hoi(:idnhiemvu); END;',
