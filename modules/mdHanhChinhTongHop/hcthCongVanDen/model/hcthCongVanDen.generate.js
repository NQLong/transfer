// Table name: HCTH_CONG_VAN_DEN { id, ngayNhan, donViGui, soCongVan, ngayCongVan, noiDung, donViNhan, canBoNhan, ngayHetHan, chiDao, linkCongVan }
const keys = ['ID'];
const obj2Db = { 'id': 'ID', 'ngayNhan': 'NGAY_NHAN', 'donViGui': 'DON_VI_GUI', 'soCongVan': 'SO_CONG_VAN', 'ngayCongVan': 'NGAY_CONG_VAN', 'trichYeu': 'TRICH_YEU', 'donViNhan': 'DON_VI_NHAN', 'canBoNhan': 'CAN_BO_NHAN', 'ngayHetHan': 'NGAY_HET_HAN', 'quyenChiDao': 'QUYEN_CHI_DAO'};
...
module.exports = app => {
    app.model.hcthCongVanDen = {
        ...
        searchPage: (pagenumber, pagesize, donviguicv, donvi, macanbo, timetype, fromtime, totime, sortby, sorttype, searchterm, done) => {
            app.database.oracle.connection.main.execute('BEGIN :ret:=hcth_cong_van_den_search_page(:pagenumber, :pagesize, :donviguicv, :donvi, :macanbo, :timetype, :fromtime, :totime, :sortby, :sorttype, :searchterm, :totalitem, :pagetotal); END;',
                { ret: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.CURSOR }, pagenumber: { val: pagenumber, dir: app.database.oracle.BIND_INOUT, type: app.database.oracle.NUMBER }, pagesize: { val: pagesize, dir: app.database.oracle.BIND_INOUT, type: app.database.oracle.NUMBER }, donviguicv, donvi, macanbo, timetype, fromtime, totime, sortby, sorttype, searchterm, totalitem: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.NUMBER }, pagetotal: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.NUMBER } }, (error, result) => app.database.oracle.fetchRowsFromCursor(error, result, done));
        },

        getAllChiDao: (idcongvan, done) => {
            app.database.oracle.connection.main.execute('BEGIN :ret:=hcth_cong_van_den_get_all_chi_dao(:idcongvan); END;',
                { ret: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.CURSOR }, idcongvan }, (error, result) => app.database.oracle.fetchRowsFromCursor(error, result, done));
        },
    };
};