module.exports = (app) => {
    ...
    app.permission.add(
        ...
        { name: 'staff:login', menu: hcthMenu },
    );
    ...
    app.post('/api/hcth/nhiem-vu/can-bo-nhan', app.permission.check('manager:write'), async (req, res) => {
    ...
    app.put('/api/hcth/nhiem-vu/can-bo-nhan', app.permission.check('manager:write'), async (req, res) => {
        //
    });
