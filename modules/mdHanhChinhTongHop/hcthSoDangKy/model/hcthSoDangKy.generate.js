...
module.exports = app => {
    app.model.hcthSoDangKy = {
        ...
        createSoVanBan: (donvigui, capvanban, loaivanban, nam, tudong, ngaytao, done) => new Promise((resolve, reject) => {
            app.database.oracle.connection.main.execute('BEGIN hcth_so_dang_ky_create_so_van_ban(:donvigui, :capvanban, :loaivanban, :nam, :tudong, :ngaytao); END;',
        ...
        validateSoCongVan: (sodangky, capvanban, donvigui, nam, done) => new Promise((resolve, reject) => {
            app.database.oracle.connection.main.execute('BEGIN hcth_so_dang_ky_validate_so_cong_van(:sodangky, :capvanban, :donvigui, :nam); END;',
        ...
        searchPage: (pagenumber, pagesize, tabvalue, searchterm, done) => new Promise((resolve, reject) => {
            app.database.oracle.connection.main.execute('BEGIN :ret:=hcth_so_dang_ky_search_page(:pagenumber, :pagesize, :tabvalue, :searchterm, :totalitem, :pagetotal); END;',
