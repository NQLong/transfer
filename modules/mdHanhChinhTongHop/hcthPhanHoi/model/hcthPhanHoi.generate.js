// Table name: HCTH_PHAN_HOI { id, noiDung, canBoGui, maNhiemVu, ngayTao, loai }
const keys = ['ID'];
const obj2Db = { 'id': 'ID', 'noiDung': 'NOI_DUNG', 'canBoGui': 'CAN_BO_GUI', 'maNhiemVu': 'MA_NHIEM_VU', 'ngayTao': 'NGAY_TAO', 'loai': 'LOAI' };
...
module.exports = app => {
    app.model.hcthPhanHoi = {
        ...
        getPage: (pageNumber, pageSize, condition, selectedColumns, orderBy, done) => {
            ...
            const sql_count = 'SELECT COUNT(*) FROM HCTH_PHAN_HOI' + (condition.statement ? ' WHERE ' + condition.statement : '');
