...
class NewsWaitApprovalPage extends React.Component {
    ...
    render() {
        const { pageNumber, pageSize, pageTotal, totalItem, list, pageCondition } = this.state ?
            this.state : { pageNumber: 1, pageSize: 50, pageTotal: 1, totalItem: 0, list: [], pageCondition: {} };
                            ...
                            <tr key={index}>
                                ...
                                <td>
                                    <div className='btn-group'>
                                        <a href='#' className='btn btn-success' onClick={() => this.changeActive(item)} title='Duyệt bản nháp này'> <i className='fa fa-check' /></a>
            ...
            <main className='app-content'>
                ...
                <div className='tile'>
                    ...
                    <Pagination name='pageNews'
                        ...
                        getPage={this.props.getDraftAdmissionNewsInPage} />
...
const mapActionsToProps = { getDraftAdmissionNewsInPage, createDraftNewsDefault, draftToNews, deleteDraftNews, updateDraftNews };
