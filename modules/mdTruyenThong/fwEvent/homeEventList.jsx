...
import { getEventByUser, getEventInPageByUser } from './redux';
...
class EventDetail extends React.Component {
    ...
    componentDidMount() {
        this.props.getEventInPageByUser(1, 25, data => {
...
const mapActionsToProps = { getEventByUser, getEventInPageByUser };
