module.exports = app => {
    const menu = {
        ...
        menus: { 6105: { title: 'Diện đóng BHYT', link: '/user/students/dien-dong-bhyt' } },
    };
    app.permission.add(
    ...
    app.delete('/api/students/dien-dong-bhyt', app.permission.check('dmDienDongBhyt:delete'), (req, res) => {
