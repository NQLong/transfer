module.exports = app => {
     ...
     app.get('/user/dao-tao/nganh-dao-tao', app.permission.orCheck('dtNganhDaoTao:read', 'manager:read'), app.templates.admin);

     // APIs -----------------------------------------------------------------------------------------------------------------------------------------
     app.get('/api/dao-tao/nganh-dao-tao/page/:pageNumber/:pageSize', app.permission.orCheck('dtNganhDaoTao:read', 'manager:read'), (req, res) => {
          const pageNumber = parseInt(req.params.pageNumber),
               pageSize = parseInt(req.params.pageSize);
          app.model.dtNganhDaoTao.getPage(pageNumber, pageSize, {}, (error, page) => res.send({ error, page }));
     });

     app.get('/api/dao-tao/nganh-dao-tao/item/:maNganh', app.permission.orCheck('dtNganhDaoTao:read', 'manager:read'), (req, res) => {
