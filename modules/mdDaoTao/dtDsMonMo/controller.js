...
module.exports = app => {
  ...
  //   menus: {
  //     7002: { title: 'Danh sách môn học mở trong học kỳ', link: '/user/pdt/danh-sach-mon-mo', icon: 'fa-calendar', backgroundColor: '#1ca474' },
  //   },
  // };
  // app.permission.add(
  ...
  app.get('/user/pdt/danh-sach-mon-mo', app.permission.orCheck('dtDsMonMo:read', 'dtDsMonMo:readAll', 'manager:read'), app.templates.admin);
  app.get('/user/pdt/danh-sach-mon-mo/:id', app.permission.orCheck('dtDsMonMo:read', 'dtDsMonMo:readAll', 'manager:read'), app.templates.admin);
