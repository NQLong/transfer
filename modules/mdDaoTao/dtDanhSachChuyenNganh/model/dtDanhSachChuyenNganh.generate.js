...
module.exports = app => {
    app.model.dtDanhSachChuyenNganh = {
            ...
            if (statement.length == 0) {
                ...
                app.database.oracle.connection.main.execute(sql, parameter, (error, resultSet) => {
                    if (error == null && resultSet && resultSet.lastRowid) {
                        app.model.dtDanhSachChuyenNganh.get({ rowId: resultSet.lastRowid }, done);
                    } else {
        ...
        getPage: (pageNumber, pageSize, condition, selectedColumns, orderBy, done) => {
            ...
            const sql_count = 'SELECT COUNT(*) FROM DT_DANH_SACH_CHUYEN_NGANH' + (condition.statement ? ' WHERE ' + condition.statement : '');
