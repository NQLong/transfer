// Table name: DT_THOI_KHOA_BIEU_GIANG_VIEN { idThoiKhoaBieu, giangVien, type }
const keys = ['GIANG_VIEN', 'ID_THOI_KHOA_BIEU', 'TYPE'];
const obj2Db = { 'idThoiKhoaBieu': 'ID_THOI_KHOA_BIEU', 'giangVien': 'GIANG_VIEN', 'type': 'TYPE' };
