module.exports = app => {
    ...
    // APIs -----------------------------------------------------------------------------------------------------------------------------------------
    app.get('/api/dao-tao/nganh-theo-to-hop-thi/page/:pageNumber/:pageSize', app.permission.orCheck('dtNganhToHop:read', 'dtChuongTrinhDaoTao:manage'), (req, res) => {
    ...
    app.get('/api/dao-tao/nganh-theo-to-hop-thi/item/:id', app.permission.orCheck('dtNganhToHop:read', 'dtChuongTrinhDaoTao:manage'), (req, res) => {
