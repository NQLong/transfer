// Table name: DT_KHUNG_DAO_TAO { id, namDaoTao, maKhoa }
const keys = ['ID'];
const obj2Db = { 'id': 'ID', 'namDaoTao': 'NAM_DAO_TAO', 'maKhoa': 'MA_KHOA' };
...
module.exports = app => {
    app.model.dtKhungDaoTao = {
        ...
        searchPage: (pagenumber, pagesize, searchterm, done) => {
            app.database.oracle.connection.main.execute('BEGIN :ret:=dt_khung_dao_tao_search_page(:pagenumber, :pagesize, :searchterm, :totalitem, :pagetotal); END;',
