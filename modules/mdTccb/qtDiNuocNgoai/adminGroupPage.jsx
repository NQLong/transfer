...
class QtDiNuocNgoaiGroupPage extends AdminPage {
    ...
    changeAdvancedSearch = (isInitial = false) => {
        let { pageNumber, pageSize } = this.props && this.props.qtDiNuocNgoai && this.props.qtDiNuocNgoai.pageMa ? this.props.qtDiNuocNgoai.pageMa : { pageNumber: 1, pageSize: 50 };
    ...
    render() {
        ...
        return this.renderPage({
            ...
            onExport: (e) => {
                ...
                T.download(T.url(`/api/qua-trinh/di-nuoc-ngoai/download-excel/${listShcc ? listShcc : null}/${listDv ? listDv : null}/${fromYear ? fromYear : null}/${toYear ? toYear : null}/${timeType}/${tinhTrang ? tinhTrang : null}/${loaiHocVi ? loaiHocVi : null}/${mucDich ? mucDich : null}`), 'dinuocngoai.xlsx');
            }
        });
    }
}
