...
class CanBoTheoDonVi extends AdminPage {
    ...
    tccbHeader = () => (
        <>
            <tr>
                ...
                <th rowSpan={1} colSpan={3} style={{ width: 'auto', whiteSpace: 'nowrap', textAlign: 'center' }}>Các thao tác với hệ thống TCCB</th>
                {/* Gán quyền xử lý công việc */}
            </tr>
            <tr>
    ...
    tccbRows = (item, index) => <tr key={index}>
        ...
        <TableCell type='text' style={{ whiteSpace: 'nowrap', fontStyle: 'italic' }} content={item.email} />
        <TableCell type='text' style={{ whiteSpace: 'nowrap', textAlign: 'center' }} content={item.dienThoaiCaNhan} />
        <TableCell type='text' style={{ whiteSpace: 'nowrap', textAlign: 'center' }} content={CRUD[item.tccbLog?.thaoTac] || ''} />
        <TableCell type='text' style={{ whiteSpace: 'nowrap', textAlign: 'center' }} content={item.tccbLog?.quaTrinh || ''} />
        <TableCell type='date' style={{ whiteSpace: 'nowrap', textAlign: 'center' }} content={item.tccbLog?.ngay || null} />
    </tr>
    ...
    render() {
        ...
        console.log(this.state.listDonViQuanLy);
        return this.renderPage({
            ...
            } minimumResultsForSearch={-1} disabled={this.state.listDonViQuanLy.length == 1} />,
