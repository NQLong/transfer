// Table name: TCCB_DINH_MUC_CONG_VIEC_GV_VA_NCV { id, idNhom, maChucDanh, soGioGiangDay, soDiemGiangDay, soGioNghienCuuKhoaHoc, soDiemNghienCuuKhoaHoc, soGioKhac, soDiemKhac, thuTu }
const keys = ['ID'];
