module.exports = app => {
    ...
    //     menus: {
    //         3035: { title: 'Quá trình bảo hiểm xã hội', link: '/user/tccb/qua-trinh/keo-dai-cong-tac', icon: 'fa-gift', backgroundColor: '#2559ba', groupIndex: 1},
    //     },
    // };
    // app.permission.add(
    ...
    // );
    // app.get('/user/tccb/qua-trinh/keo-dai-cong-tac/:id', app.permission.check('qtKeoDaiCongTac:read'), app.templates.admin);
