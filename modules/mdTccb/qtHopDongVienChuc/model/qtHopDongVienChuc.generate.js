...
module.exports = app => {
    app.model.qtHopDongVienChuc = {
        ...
        searchPage: (pagenumber, pagesize, listShcc, listDv, fromyear, toyear, searchterm, done) => new Promise((resolve, reject) => {
            app.database.oracle.connection.main.executeExtra('BEGIN :ret:=qt_hop_dong_vien_chuc_search_page(:pagenumber, :pagesize, :listShcc, :listDv, :fromyear, :toyear, :searchterm, :totalitem, :pagetotal); END;',
