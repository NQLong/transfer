...
import {
    getQtHopDongTrachNhiemPage, updateQtHopDongTrachNhiem,
    deleteQtHopDongTrachNhiem, createQtHopDongTrachNhiem,
} from './redux';
...
class QtHopDongTrachNhiemPage extends AdminPage {
    ...
    changeAdvancedSearch = (isInitial = false) => {
        let { pageNumber, pageSize } = this.props && this.props.qtHopDongTrachNhiem && this.props.qtHopDongTrachNhiem.page ? this.props.qtHopDongTrachNhiem.page : { pageNumber: 1, pageSize: 50 };
    ...
    getPage = (pageN, pageS, pageC, done) => {
        if (this.checked) this.props.getQtHopDongTrachNhiemGroupPage(pageN, pageS, pageC, this.state.filter, done);
        else this.props.getQtHopDongTrachNhiemPage(pageN, pageS, pageC, this.state.filter, done);
    }
    ...
    delete = (e, item) => {
        T.confirm('Xóa hợp đồng', 'Bạn có chắc bạn muốn xóa hợp đồng này?', 'warning', true, isConfirm => {
            isConfirm && this.props.deleteQtHopDongTrachNhiem(item.ma, error => {
    ...
    render() {
        ...
        let { pageNumber, pageSize, pageTotal, totalItem, pageCondition, list } = this.checked ?
            ...
            : (this.props.qtHopDongTrachNhiem && this.props.qtHopDongTrachNhiem.page ? this.props.qtHopDongTrachNhiem.page : { pageNumber: 1, pageSize: 50, pageTotal: 1, totalItem: 0, pageCondition: {}, list: [] });
...
const mapActionsToProps = {
    getQtHopDongTrachNhiemPage, updateQtHopDongTrachNhiem,
    deleteQtHopDongTrachNhiem, createQtHopDongTrachNhiem, getDmDonViAll
};
export default connect(mapStateToProps, mapActionsToProps)(QtHopDongTrachNhiemPage);