...
import {
    getQtHopDongDvtlPage, getQtHopDongDvtlAll, updateQtHopDongDvtl,
    deleteQtHopDongDvtl, createQtHopDongDvtl, getQtHopDongDvtlGroupPage
} from './redux';
...
class QtHopDongDvtlPage extends AdminPage {
    ...
    changeAdvancedSearch = (isInitial = false) => {
        let { pageNumber, pageSize } = this.props && this.props.qtHopDongDvtl && this.props.qtHopDongDvtl.page ? this.props.qtHopDongDvtl.page : { pageNumber: 1, pageSize: 50 };
    ...
    delete = (e, item) => {
        T.confirm('Xóa hợp đồng', 'Bạn có chắc bạn muốn xóa hợp đồng này?', 'warning', true, isConfirm => {
            isConfirm && this.props.deleteQtHopDongDvtl(item.ID, error => {
    ...
    render() {
        ...
        let { pageNumber, pageSize, pageTotal, totalItem, pageCondition, list } = this.checked ?
            ...
            : (this.props.qtHopDongDvtl && this.props.qtHopDongDvtl.page ? this.props.qtHopDongDvtl.page : { pageNumber: 1, pageSize: 50, pageTotal: 1, totalItem: 0, pageCondition: {}, list: [] });
...
const mapActionsToProps = {
    getQtHopDongDvtlPage, getQtHopDongDvtlAll, updateQtHopDongDvtl,
    deleteQtHopDongDvtl, createQtHopDongDvtl, getQtHopDongDvtlGroupPage, getDmDonViAll
};
