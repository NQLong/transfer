...
export function getTccbKhungDanhGiaCanBoAll(condition, done) {
    ...
    return dispatch => {
        const url = '/api/danh-gia/cau-truc-khung-danh-gia-can-bo/all';
...
export function getTccbKhungDanhGiaCanBo(id, done) {
    return () => {
        const url = `/api/danh-gia/cau-truc-khung-danh-gia-can-bo/item/${id}`;
        T.get(url, data => {
            if (data.error) {
...
export function createTccbKhungDanhGiaCanBo(item, done) {
    return dispatch => {
        const url = '/api/danh-gia/cau-truc-khung-danh-gia-can-bo';
