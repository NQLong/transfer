...
class QtCongTacTrongNuocGroupPage extends AdminPage {
    ...
    changeAdvancedSearch = (isInitial = false) => {
        let { pageNumber, pageSize } = this.props && this.props.qtCongTacTrongNuoc && this.props.qtCongTacTrongNuoc.page_ma ? this.props.qtCongTacTrongNuoc.page_ma : { pageNumber: 1, pageSize: 50 };
    ...
    render() {
        ...
        let { pageNumber, pageSize, pageTotal, totalItem, pageCondition, list } = this.props.qtCongTacTrongNuoc && this.props.qtCongTacTrongNuoc.page_ma ? this.props.qtCongTacTrongNuoc.page_ma : { pageNumber: 1, pageSize: 50, pageTotal: 1, totalItem: 0, pageCondition: {}, list: [] };
