...
module.exports = app => {
    ...
    app.model.qtKyLuat.download = (list_shcc, list_dv, fromYear, toYear, done) => {
        app.dbConnection.execute('BEGIN :ret:=qt_ky_luat_download_excel(:list_shcc, :list_dv, :fromYear, :toYear); END;',
            { ret: { dir: app.oracleDB.BIND_OUT, type: app.oracleDB.CURSOR }, list_shcc, list_dv, fromYear, toYear }, (error, result) => app.dbConnection.fetchRowsFromCursor(error, result, done));
    };
};