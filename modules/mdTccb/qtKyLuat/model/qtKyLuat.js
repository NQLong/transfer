...
module.exports = app => {
    ...
    app.model.qtKyLuat.searchPage = (pagenumber, pagesize, loaiDoiTuong, searchterm, done) => {
    ...
    app.model.qtKyLuat.getByShcc = (isShcc, done) => {
        app.dbConnection.execute('BEGIN :ret:=qt_ky_luat_by_shcc(:isShcc); END;',
