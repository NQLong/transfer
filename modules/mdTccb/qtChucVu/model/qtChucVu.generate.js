...
module.exports = app => {
    app.model.qtChucVu = {
        ...
        searchPage: (pagenumber, pagesize, listShcc, listDv, fromyear, toyear, timetype, searchterm, done) => {
            app.dbConnection.execute('BEGIN :ret:=qt_chuc_vu_search_page(:pagenumber, :pagesize, :listShcc, :listDv, :fromyear, :toyear, :timetype, :searchterm, :totalitem, :pagetotal); END;',
