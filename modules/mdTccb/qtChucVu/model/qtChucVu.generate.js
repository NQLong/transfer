...
module.exports = app => {
    app.model.qtChucVu = {
        ...
        searchPage: (pagenumber, pagesize, listshcc, listdv, fromyear, toyear, timetype, listcv, listcd, gioitinh, searchterm, done) => {
            app.database.oracle.connection.main.execute('BEGIN :ret:=qt_chuc_vu_search_page(:pagenumber, :pagesize, :listshcc, :listdv, :fromyear, :toyear, :timetype, :listcv, :listcd, :gioitinh, :searchterm, :totalitem, :pagetotal); END;',
                { ret: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.CURSOR }, pagenumber: { val: pagenumber, dir: app.database.oracle.BIND_INOUT, type: app.database.oracle.NUMBER }, pagesize: { val: pagesize, dir: app.database.oracle.BIND_INOUT, type: app.database.oracle.NUMBER }, listshcc, listdv, fromyear, toyear, timetype, listcv, listcd, gioitinh, searchterm, totalitem: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.NUMBER }, pagetotal: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.NUMBER } }, (error, result) => app.database.oracle.fetchRowsFromCursor(error, result, done));
        },

        groupPage: (pagenumber, pagesize, listshcc, listdv, fromyear, toyear, timetype, listcv, listcd, gioitinh, searchterm, done) => {
            app.database.oracle.connection.main.execute('BEGIN :ret:=qt_chuc_vu_group_page(:pagenumber, :pagesize, :listshcc, :listdv, :fromyear, :toyear, :timetype, :listcv, :listcd, :gioitinh, :searchterm, :totalitem, :pagetotal); END;',
                { ret: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.CURSOR }, pagenumber: { val: pagenumber, dir: app.database.oracle.BIND_INOUT, type: app.database.oracle.NUMBER }, pagesize: { val: pagesize, dir: app.database.oracle.BIND_INOUT, type: app.database.oracle.NUMBER }, listshcc, listdv, fromyear, toyear, timetype, listcv, listcd, gioitinh, searchterm, totalitem: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.NUMBER }, pagetotal: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.NUMBER } }, (error, result) => app.database.oracle.fetchRowsFromCursor(error, result, done));
        },
