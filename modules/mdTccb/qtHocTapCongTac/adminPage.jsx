...
import { AdminPage, TableCell, renderTable, AdminModal, FormSelect, FormCheckbox, FormRichTextBox } from 'view/component/AdminPage';
import Pagination from 'view/component/Pagination';
import {
    createQTHocTapCongTacStaff, updateQTHocTapCongTacStaff, deleteQTHocTapCongTacStaff,
    getQtHocTapCongTacGroupPage, getQtHocTapCongTacPage,
} from './redux';
...
class QtHocTapCongTac extends AdminPage {
    ...
    componentDidMount() {
        T.ready('/user/tccb', () => {
            T.onSearch = (searchText) => {
                ...
                if (this.checked) this.props.getQtHocTapCongTacGroupPage(undefined, undefined, this.curState, this.searchText || '');
                else this.props.getQtHocTapCongTacPage(undefined, undefined, this.curState, this.searchText || '');
            };
            T.showSearchBox(() => {
    ...
    changeAdvancedSearch = () => {
        ...
        if (this.checked) this.props.getQtHocTapCongTacGroupPage(pageNumber, pageSize, this.curState, this.searchText || '');
        else this.props.getQtHocTapCongTacPage(pageNumber, pageSize, this.curState, this.searchText || '');
    }
    ...
    render() {
        ...
        console.log(this.props.qtHocTapCongTac);
