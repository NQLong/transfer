...
import {
    getQtLamViecNgoaiGroupPageMa, deleteQtLamViecNgoaiGroupPageMa, createQtLamViecNgoaiGroupPageMa,
    updateQtLamViecNgoaiGroupPageMa
}
    from './redux';
...
class EditModal extends AdminModal {
    ...
    onShow = (item) => {
        let { id, shcc, noiDung, batDau, batDauType, ketThuc, ketThucType, noiLamViec } = item ? item : {
            id: '', shcc: '', noiDung: '', tenCoSo: '', batDau: null, batDauType: '', ketThuc: null, ketThucType: '', noiLamViec: ''
        };
...
class QtLamViecNgoaiGroupPage extends AdminPage {
    state = { filter: {} };

    componentDidMount() {
        T.ready('/user/tccb', () => {
            T.clearSearchBox();
            const route = T.routeMatcher('/user/tccb/qua-trinh/lam-viec-ngoai/group/:shcc'),
    ...
    changeAdvancedSearch = (isInitial = false) => {
        let { pageNumber, pageSize } = this.props && this.props.qtLamViecNgoai && this.props.qtLamViecNgoai.page_ma ? this.props.qtLamViecNgoai.page_ma : { pageNumber: 1, pageSize: 50 };
    ...
    getPage = (pageN, pageS, pageC, done) => {
        this.props.getQtLamViecNgoaiGroupPageMa(pageN, pageS, pageC, this.state.filter, done);
    }
    ...
    render() {
        ...
        let { pageNumber, pageSize, pageTotal, totalItem, pageCondition, list } = this.props.qtLamViecNgoai && this.props.qtLamViecNgoai.page_ma ? this.props.qtLamViecNgoai.page_ma : { pageNumber: 1, pageSize: 50, pageTotal: 1, totalItem: 0, pageCondition: {}, list: [] };
        ...
        return this.renderPage({
            ...
            content: <>
                ...
                <EditModal ref={e => this.modal = e} permission={permission}
                    ...
                    create={this.props.createQtLamViecNgoaiGroupPageMa} update={this.props.updateQtLamViecNgoaiGroupPageMa}
                />
            </>,
            backRoute: '/user/tccb/qua-trinh/lam-viec-ngoai',
...
const mapActionsToProps = {
    getQtLamViecNgoaiGroupPageMa, deleteQtLamViecNgoaiGroupPageMa,
    updateQtLamViecNgoaiGroupPageMa, createQtLamViecNgoaiGroupPageMa,
};
export default connect(mapStateToProps, mapActionsToProps)(QtLamViecNgoaiGroupPage);