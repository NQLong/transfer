...
import { createUser, updateUser } from '../../../fwUser/reduxUser';
...
class AddAnswerModal extends React.Component {
    ...
    saveUser = (e) => {
        ...
        if (this.state.user && this.state.user.id) {
            this.props.updateUser(this.state.user.id, changes);
        } else {
    ...
    save = (e) => {
        if (this.state.user && this.state.user.id) {
            const { eventId } = this.props ? this.props : { eventId: '' };
            ...
            if (i == questionList.length) {
                const changes = { eventId, user: this.state.user.id, record };
                                ...
                                <div className='tile'>
                                    ...
                                    <div className='tile-footer'>
                                        <button className='btn btn-success' type='button' onClick={this.saveUser}>
                                            <i className='fa fa-fw fa-lg fa-save' />{this.state.user ? 'Cập nhật user' : 'Tạo user'}
                                        </button>
                                        &nbsp;&nbsp;&nbsp;
                                        ...
                                        &nbsp;&nbsp;&nbsp;
                                        {this.state.user && this.state.user.id && !readOnly ? (
