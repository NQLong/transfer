...
module.exports = app => {
    app.model.qtNghienCuuKhoaHoc = {
        ...
        searchPage: (pagenumber, pagesize, searchterm, masocanbo, loaihocvi, fromyear, toyear, timetype, madonvi, done) => {
            app.database.oracle.connection.main.execute('BEGIN :ret:=qt_nghien_cuu_khoa_hoc_search_page(:pagenumber, :pagesize, :searchterm, :masocanbo, :loaihocvi, :fromyear, :toyear, :timetype, :madonvi, :totalitem, :pagetotal); END;',
                { ret: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.CURSOR }, pagenumber: { val: pagenumber, dir: app.database.oracle.BIND_INOUT, type: app.database.oracle.NUMBER }, pagesize: { val: pagesize, dir: app.database.oracle.BIND_INOUT, type: app.database.oracle.NUMBER }, searchterm, masocanbo, loaihocvi, fromyear, toyear, timetype, madonvi, totalitem: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.NUMBER }, pagetotal: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.NUMBER } }, (error, result) => app.database.oracle.fetchRowsFromCursor(error, result, done));
        },

        groupPage: (pagenumber, pagesize, searchterm, masocanbo, loaihocvi, fromyear, toyear, timetype, madonvi, done) => {
            app.database.oracle.connection.main.execute('BEGIN :ret:=qt_nghien_cuu_khoa_hoc_group_page(:pagenumber, :pagesize, :searchterm, :masocanbo, :loaihocvi, :fromyear, :toyear, :timetype, :madonvi, :totalitem, :pagetotal); END;',
                { ret: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.CURSOR }, pagenumber: { val: pagenumber, dir: app.database.oracle.BIND_INOUT, type: app.database.oracle.NUMBER }, pagesize: { val: pagesize, dir: app.database.oracle.BIND_INOUT, type: app.database.oracle.NUMBER }, searchterm, masocanbo, loaihocvi, fromyear, toyear, timetype, madonvi, totalitem: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.NUMBER }, pagetotal: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.NUMBER } }, (error, result) => app.database.oracle.fetchRowsFromCursor(error, result, done));
        },

        downloadExcel: (masocanbo, loaihocvi, fromyear, toyear, timetype, madonvi, done) => {
            app.database.oracle.connection.main.execute('BEGIN :ret:=qt_nghien_cuu_khoa_hoc_download_excel(:masocanbo, :loaihocvi, :fromyear, :toyear, :timetype, :madonvi); END;',
                { ret: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.CURSOR }, masocanbo, loaihocvi, fromyear, toyear, timetype, madonvi }, (error, result) => app.database.oracle.fetchRowsFromCursor(error, result, done));
        },

        userPage: (staffemail, done) => {
            app.database.oracle.connection.main.execute('BEGIN :ret:=qt_nghien_cuu_khoa_hoc_user_page(:staffemail); END;',
                { ret: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.CURSOR }, staffemail }, (error, result) => app.database.oracle.fetchRowsFromCursor(error, result, done));
        },
    };
};