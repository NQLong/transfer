...
module.exports = app => {
    app.model.qtNghienCuuKhoaHoc = {
        ...
        searchPage: (pagenumber, pagesize, searchterm, masocanbo, loaihocvi, fromyear, toyear, timetype, madonvi, done) => new Promise((resolve, reject) => {
            app.database.oracle.connection.main.executeExtra('BEGIN :ret:=qt_nghien_cuu_khoa_hoc_search_page(:pagenumber, :pagesize, :searchterm, :masocanbo, :loaihocvi, :fromyear, :toyear, :timetype, :madonvi, :totalitem, :pagetotal); END;',
        ...
        groupPage: (pagenumber, pagesize, searchterm, masocanbo, loaihocvi, fromyear, toyear, timetype, madonvi, done) => new Promise((resolve, reject) => {
            app.database.oracle.connection.main.executeExtra('BEGIN :ret:=qt_nghien_cuu_khoa_hoc_group_page(:pagenumber, :pagesize, :searchterm, :masocanbo, :loaihocvi, :fromyear, :toyear, :timetype, :madonvi, :totalitem, :pagetotal); END;',
                { ret: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.CURSOR }, pagenumber: { val: pagenumber, dir: app.database.oracle.BIND_INOUT, type: app.database.oracle.NUMBER }, pagesize: { val: pagesize, dir: app.database.oracle.BIND_INOUT, type: app.database.oracle.NUMBER }, searchterm, masocanbo, loaihocvi, fromyear, toyear, timetype, madonvi, totalitem: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.NUMBER }, pagetotal: { dir: app.database.oracle.BIND_OUT, type: app.database.oracle.NUMBER } }, (error, result) => app.database.oracle.fetchRowsFromCursor(error, result, (error, result) => {
                    if (error) {
                        done && done(error);
                        reject(error);
