...
class TcTongGiaoDich extends AdminPage {
    state = {
        filter: {},
    }
    componentDidMount() {
        T.ready('/user/finance/tong-giao-dich', () => {
    ...
    changeAdvancedSearch = (isInitial = false, isReset = false) => {
        let { pageNumber, pageSize, pageCondition } = this.props && this.props.tcTongGiaoDich && this.props.tcTongGiaoDich.page ? this.props.tcTongGiaoDich.page : { pageNumber: 1, pageSize: 50, pageCondition: '' };
    ...
    render() {
        let permission = this.getUserPermission('tcTongGiaoDich');
        let { pageNumber, pageSize, pageTotal, totalItem, pageCondition, list } = this.props.tcTongGiaoDich && this.props.tcTongGiaoDich.page ? this.props.tcTongGiaoDich.page : {
...
const mapStateToProps = state => ({ system: state.system, tcTongGiaoDich: state.finance.tcTongGiaoDich });
const mapActionsToProps = { getTongGiaoDichPage };
export default connect(mapStateToProps, mapActionsToProps)(TcTongGiaoDich);