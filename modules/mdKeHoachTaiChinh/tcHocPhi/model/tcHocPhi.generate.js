...
module.exports = app => {
    app.model.tcHocPhi = {
        ...
        getAllFeeOfStudent: (imssv, done) => new Promise((resolve, reject) => {
            app.database.oracle.connection.main.executeExtra('BEGIN :ret:=tc_hoc_phi_get_all_mssv(:imssv, :hocphidetailall); END;',
        ...
        getDetail: (masosinhvien, hocky, namhoc, done) => new Promise((resolve, reject) => {
            app.database.oracle.connection.main.executeExtra('BEGIN :ret:=tc_hoc_phi_get_detail(:masosinhvien, :hocky, :namhoc); END;',
