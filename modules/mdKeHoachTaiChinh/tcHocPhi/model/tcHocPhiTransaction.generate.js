...
module.exports = app => {
    app.model.tcHocPhiTransaction = {
        ...
        searchPage: (pagenumber, pagesize, imssv, searchterm, filter, done) => new Promise((resolve, reject) => {
            app.database.oracle.connection.main.execute('BEGIN :ret:=tc_hoc_phi_transaction_search_page(:pagenumber, :pagesize, :imssv, :searchterm, :filter, :totalitem, :pagetotal, :totalcurrent, :totalpaid); END;',
