...
module.exports = app => {
    app.model.tcHocPhiTransaction = {
        ...
        addBill: (namhoc, hocky, ebank, transid, transdate, customerid, billid, serviceid, eamount, echecksum, done) => new Promise((resolve, reject) => {
            app.database.oracle.connection.main.executeExtra('BEGIN :ret:=tc_hoc_phi_transaction_add_bill(:namhoc, :hocky, :ebank, :transid, :transdate, :customerid, :billid, :serviceid, :eamount, :echecksum); END;',
        ...
        searchPage: (pagenumber, pagesize, searchterm, filter, done) => new Promise((resolve, reject) => {
            app.database.oracle.connection.main.executeExtra('BEGIN :ret:=tc_hoc_phi_transaction_search_page(:pagenumber, :pagesize, :searchterm, :filter, :totalitem, :pagetotal); END;',
