...
module.exports = app => {
    ...
    app.model.tcHocPhi.insertAndUpdate = (datas, done) => {
        ...
        // const sql = `MERGE INTO TC_HOC_PHI USING DUAL ON (MSSV=:mssv AND NAM_HOC=:namHoc AND HOC_KY=:hocKy)
        //         WHEN MATCHED THEN UPDATE SET HOC_PHI=:hocPhi, CONG_NO=:congNo, NGAY_TAO=:ngayTao, BILL_DATE=:billDate, BILL_DUE_DATE=:billDueDate
        //         WHEN NOT MATCHED THEN INSERT (HOC_KY, MSSV, NAM_HOC, HOC_PHI, CONG_NO, NGAY_TAO, BILL_DATE, BILL_DUE_DATE) VALUES (:hocKy, :mssv, :namHoc, :hocPhi, :congNo, :ngayTao, :billDate, :billDueDate)`;
