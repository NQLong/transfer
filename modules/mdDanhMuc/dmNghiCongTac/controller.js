module.exports = app => {
    const menu = {
        ...
        menus: { 2154: { title: 'Nghỉ công tác', link: '/user/danh-muc/nghi-cong-tac' } },
    };
    app.permission.add(
    ...
    app.get('/user/danh-muc/nghi-cong-tac', app.permission.check('dmNghiCongTac:read'), app.templates.admin);
