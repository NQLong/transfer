module.exports = app => {
    const menu = {
        ...
        menus: {
            48: { title: 'Mục Đích Trong Nước', link: '/user/danh-muc/muc-dich-trong-nuoc' },
        },
    };
    app.permission.add(
    ...
    app.get('/user/danh-muc/muc-dich-trong-nuoc', app.permission.check('dmMucDichTrongNuoc:read'), app.templates.admin);
