module.exports = app => {
    ...
    const menu = {
        ...
        menus: {
            4071: { title: 'Tình trạng thiết bị', link: '/user/danh-muc/tinh-trang-thiet-bi' },
        },
    };
    ...
    app.get('/user/danh-muc/tinh-trang-thiet-bi', app.permission.check('dmTinhTrangThietBi:read'), app.templates.admin);
