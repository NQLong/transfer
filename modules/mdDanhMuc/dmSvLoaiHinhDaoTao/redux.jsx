...
export function getDmSvLoaiHinhDaoTaoPage(pageNumber, pageSize, done) {
  ...
  return dispatch => {
    const url = `/api/danh-muc/dao-tao/loai-hinh-dao-tao/page/${page.pageNumber}/${page.pageSize}`;
    T.get(url, data => {
      if (data.error) {
...
export function getDmSvLoaiHinhDaoTao(ma, done) {
  return () => {
    const url = `/api/danh-muc/dao-tao/loai-hinh-dao-tao/item/${ma}`;
    T.get(url, data => {
      if (data.error) {
...
export function createDmSvLoaiHinhDaoTao(item, done) {
  return dispatch => {
    const url = '/api/danh-muc/dao-tao/loai-hinh-dao-tao';
