module.exports = app => {
    const menu = {
        ...
        menus: {
            4012: { title: 'Chứng chỉ Anh Văn', link: '/user/danh-muc/chung-chi-tieng-anh' },
        },
    };
    app.permission.add(
    ...
    app.get('/user/danh-muc/chung-chi-tieng-anh', app.permission.check('dmChungChiTiengAnh:read'), app.templates.admin);
