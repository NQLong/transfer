module.exports = app => {
    const menu = {
        ...
        menus: {
            4029: { title: 'Hỗ trợ học phí', link: '/user/danh-muc/ho-tro-hoc-phi' },
        },
    };
    app.permission.add(
    ...
    app.get('/user/danh-muc/ho-tro-hoc-phi', app.permission.check('dmHoTroHocPhi:read'), app.templates.admin);
