module.exports = app => {
    const menu = {
        ...
        menus: {
            4048: { title: 'Mục đích đi nước ngoài', link: '/user/danh-muc/muc-dich-nuoc-ngoai' },
        },
    };
    app.permission.add(
    ...
    app.get('/user/danh-muc/muc-dich-nuoc-ngoai', app.permission.check('dmMucDichNuocNgoai:read'), app.templates.admin);
