    ...
    render = () => {
        ...
        return this.renderModal({
            ...
            body: <div className='row'>
                <FormTextBox type='text' className='col-md-12' ref={e => this.ma = e} label='Mã loại hình đào tạo' readOnly={readOnly} required />
                <FormTextBox
                    type='text'
                    className='col-md-12'
                    ref={e => this.ten = e}
        ...
        if (list && list.length > 0) {
            table = renderTable({
                ...
                renderRow: (item, index) => (
                    <tr key={index}>
                        <TableCell type='text' content={index + 1} style={{ whiteSpace: 'nowrap' }} />
