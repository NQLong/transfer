module.exports = app => {
    const menu = {
        ...
        menus: {
            4002: { title: 'Tăng Bảo hiểm xã hội', link: '/user/danh-muc/tang-bao-hiem-xa-hoi'},
        },
    };
    app.permission.add(
    ...
    app.get('/user/danh-muc/tang-bao-hiem-xa-hoi', app.permission.check('dmTangBhxh:read'), app.templates.admin);
