module.exports = app => {
    const menu = {
        ...
        menus: {
            4075: { title: 'Trình độ Lý luận chính trị', link: '/user/danh-muc/trinh-do-ly-luan-chinh-tri' },
        },
    };
    app.permission.add(
    ...
    app.get('/user/danh-muc/trinh-do-ly-luan-chinh-tri', app.permission.check('dmTrinhDoLyLuanChinhTri:read'), app.templates.admin);
