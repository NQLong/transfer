...
import { createDmMonHocSdhMoiMutiple } from './redux';
...
class AdminSvSdhUploadPage extends AdminPage {
    ...
    componentDidMount() {
        T.ready('/user/oisp', () => {
            this.fileBox.setData('dmMonHocSdhMoiImportData');
        });
    }
    ...
    save = () => {
        ...
        if (data.length == 0) {
            ...
            this.props.createDmMonHocSdhMoiMutiple(data, () => {
                this.setState({ loading: false });
                this.props.history.push('/user/sau-dai-hoc/mon-hoc-moi');
            });
        }
    }
    ...
    render() {
        ...
        return this.renderPage({
            ...
            breadcrumb: [
                ...
                <Link key={1} to='/user/sau-dai-hoc/mon-hoc-moi'>Danh mục Môn học sau đại học</Link>,
                'Import data'
            ],
            content: <>
                {this.state.loading ?
                    ...
                    [<div key={0} className='tile'>
                        <div className='row  justify-content-center'>
                            <FormFileBox ref={e => this.fileBox = e} className='col-md-6' postUrl='/user/upload' uploadType='dmMonHocSdhMoiFile' userData='dmMonHocSdhMoiImportData' onSuccess={this.onSuccess} />
                        </div>
                    </div>,
            ...
            backRoute: '/user/sau-dai-hoc/mon-hoc-moi'
...
const mapActionsToProps = { createDmMonHocSdhMoiMutiple };
