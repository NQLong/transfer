...
class TreeModal extends AdminModal {
    ...
    onShow = (item) => {
        ...
        this.props.getSdhChuongTrinhDaoTao(id, (ctsdh) => {
            SelectAdapter_SdhCauTrucKhungDaoTao.fetchOne(idNamDaoTao, (rs) => {
                const { data } = rs;
                ...
                this.setState({ monHoc: ctsdh, chuongTrinhDaoTaoCha: chuongTrinhDaoTaoCha, chuongTrinhDaoTaoCon: chuongTrinhDaoTaoCon, mucConSwitch: mucConSwitch, hocKySwitch: hocKySwitch });
            });
        });
    };
...
class SdhChuongTrinhDaoTaoPage extends AdminPage {
    ...
    render() {
        const permissionDaoTao = this.getUserPermission('sdhChuongTrinhDaoTao', ['read', 'write', 'delete', 'manage']);
        let permission = {
