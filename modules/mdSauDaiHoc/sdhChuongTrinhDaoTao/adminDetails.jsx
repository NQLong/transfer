...
import { createMultiSdhChuongTrinhDaoTao, createSdhChuongTrinhDaoTao, updateSdhChuongTrinhDaoTao, getSdhChuongTrinhDaoTao, getDtKhungDaoTao, deleteMultiSdhChuongTrinhDaoTao, downloadWord } from './redux';
...
class SdhChuongTrinhDaoTaoDetails extends AdminPage {
    ...
    getData = (id, isClone = false, khoaDt) => {
        id && this.props.getDtKhungDaoTao(id, (data) => {
            ...
            this.props.getSdhChuongTrinhDaoTao(id, (ctdt) => {
                ...
                <div className='tile'>
                    ...
                    <div className='tile-body'>
                        <div className='row'>
                            ...
                            <FormSelect ref={e => this.khoa = e} data={SelectAdapter_DmNganhSdh} label='Nơi đào tạo' className='col-12' readOnly={!isPhongDaoTao} />
                        </div>
                    </div>
                </div>
...
const mapActionsToProps = { createMultiSdhChuongTrinhDaoTao, getSdhChuongTrinhDaoTao, getDtKhungDaoTao, createSdhChuongTrinhDaoTao, updateSdhChuongTrinhDaoTao, deleteMultiSdhChuongTrinhDaoTao, downloadWord };
