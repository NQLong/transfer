                    ...
                    <div className='modal-content'>
                        <div className='modal-header' style={{ padding: 0 }}>
                            <ul className='nav nav-pills nav-fill'
                                ...
                                <li className='nav-item'>
                                    <a href='#login' onClick={this.onNavLinkClick} className='nav-link' style={{ paddingTop: '12px', paddingBottom: '12px', borderRadius: '0 4.5px 0 0' }}>{language.loginTitle}</a>
                                </li>
                            </ul>
                        </div>
                        <form className='needs-validation' onSubmit={this.onSubmit} noValidate={true}>
                            <div className='modal-body'>
                                ...
                                <div className='form-group row'>
                                    <label className='col-sm-3 col-form-label'>{language.password}</label>
                                    <div className='col-sm-9'>
                                        ...
                                        <a style={{ margin: '10px' }} ref={this.btnForgotPassword} href='#' className='onlyLoginForm'
                                            onClick={this.onForgotPasswordClick}>{language.forgotPassword}</a>
                                    </div>
                                </div>
