...
export default class ImageBox extends React.Component {
    ...
    getImage = () => { return this.state.image; };
    ...
    onUploadFile = (file) => {
        ...
        if (sizeFiles && sizeFiles > 2) {
            T.alert(` Thao tác không thành công, Tệp hình ảnh có kích thước ${Math.round(sizeFiles * 100) / 100} MB, yêu cầu ảnh dưới 2MB`, 'warning', false, 2000);
            return;
        }
