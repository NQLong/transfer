...
export default DefaultScreenTabs = ({ navigation }) => {
    ...
    return (
        <Tab.Navigator initialRouteName="vanBanDiPage" screenOptions={{ tabBarActiveTintColor: colors.primary, headerStyle: { backgroundColor: colors.primary }, headerTitleStyle: { color: colors.white } }}>
            <Tab.Screen name="congVanDenPage" component={CongVanDenPage} options={{
                headerTitle: 'Công văn đến', tabBarLabel: 'Công văn đến',
            ...
            <Tab.Screen name="vanBanDiPage" component={VanBanDiPage}
                options={{
                    headerTitle: 'Văn bản đi', tabBarLabel: 'Văn bản đi',
            ...
            <Tab.Screen name="user" component={User}
                options={{
                    headerTitle: 'Trang cá nhân', tabBarLabel: 'Trang cá nhân',
